package com.example.roberto.masterdetailexemple;
...
import com.example.roberto.masterdetailexemple.dummy.DummyContent;
...
public class BlogPostDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.blogpost_detail)).setText(mItem.mDescription);
        }
